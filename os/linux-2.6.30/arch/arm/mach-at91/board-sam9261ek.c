...
static void __init ek_map_io(void)
{
	...
	/* UART0 on ttyS1 */
	at91_register_uart(AT91SAM9261_ID_US0, 1, ATMEL_UART_RTS);
...
static struct gpio_keys_button ek_buttons[] = {
	{
		.gpio		= AT91_PIN_PB5,     //AT91_PIN_PA27,
		.code		= BTN_0,
		.desc		= "Button 0",
		.active_low	= 1,
		.wakeup		= 1,
...
static void __init ek_add_device_buttons(void)
{
	...
	at91_set_gpio_input(AT91_PIN_PB5, 1);	/* btn0 */
	at91_set_deglitch(AT91_PIN_PB5, 1);
...
static void __init ek_board_init(void)
{
	...
	//Make sure gpio port Port B is IO mode for aloka board
	//at91_set_gpio_input(AT91_PIN_PB5,1);  //Shut down signal, input
	at91_set_gpio_input(AT91_PIN_PB8,1);  //
	at91_set_gpio_output(AT91_PIN_PB15,1);//Level NG, output
	at91_set_gpio_output(AT91_PIN_PB17,1); //Shut down OK, ouput,1 ok
